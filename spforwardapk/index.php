...
?>
    ...
    <head>
        ...
        <title>Sistem Pakar Ilham</title>
        ...
        <link href="assets/images/logouniga.jpeg" type="image/x-icon" rel="shortcut icon">
        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                <a href="./" class="logo">
                    ...
                    <span class="logo-lg"><b>Sistem Pakar</b> Gangguan Pernapasan</span>
                </a>
                <!-- Header Navbar -->
            ...
            <footer class="main-footer">
                <strong>
                    Fakultas Teknik <i class=""></i> <b><a style="color: #008cba" href="http://www.mycoding.net" target="_blank">Universitas Garut</a></b>
                </strong>
            </footer>
